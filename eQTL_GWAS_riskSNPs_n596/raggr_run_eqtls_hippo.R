...
# [1] 15.92
keepInd = which(rse_gene_joint$Region == "HIPPO")
...
## keep SNPs from list
keepIndex = which((snpMap$pos_hg19 %in% riskLoci$hg19POS) & (snpMap$pos_hg19 %in% snpMap_dg$pos_hg19))	# keep 6350 snps
...
save(genePCs, exonPCs, jxnPCs, txPCs, 
	file="rdas/pcs_4features_hippo_333.rda")
# load("rdas/pcs_4features_hippo_333.rda")
